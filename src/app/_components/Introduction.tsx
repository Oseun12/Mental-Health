    ...
    <section className="bg-gray-50 py-20">
      <div className="mx-auto max-w-screen-3xl px-4 lg:flex lg:items-center">
        <div className=" text-center mx-auto">
            ...
            <p className="mt-6 text-lg mx-auto max-w-3xl text-gray-700 leading-relaxed">
            ...
            <div className='md:flex mx-auto max-w-screen-xl gap-10'>
                <div className='md:w-1/2'>
                    ...
                    <h2 className="mt-8 text-2xl font-semibold text-gray-800">Common Mental Health Challenges</h2>
                ...
                <div className='md:w-1/2'>
                    ...
                    <h2 className="mt-8 text-2xl font-semibold text-gray-800">Breaking the Stigma Around Mental Health</h2>
                    <p className="mt-4 text-lg text-gray-700 leading-relaxed">
